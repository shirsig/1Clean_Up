...
function broom:ADDON_LOADED()
	...
	self.mount = self:set(
		...
		-- rams
		5864, 5872, 5873, 18785, 18786, 18787, 18244, 19030,

		-- horses
		2411, 2414, 5655, 5656, 18778, 18776, 18777, 18241,

		-- sabers
		8629, 8631, 8632, 18766, 18767, 18902, 18242, 13086, 19902,

		-- mechanostriders
		8563, 8595, 13321, 13322, 18772, 18773, 18774, 18243,

		-- kodos
		15277, 15290, 18793, 18794, 18795, 18247,

		-- wolves
		1132, 5665, 5668, 18796, 18797, 18798, 18245,

		-- raptors
		8588, 8591, 8592, 18788, 18789, 18790, 18246, 19872,
